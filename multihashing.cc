...
Handle<Value> thriddle(const Arguments& args) {
    HandleScope scope;
    ...
    thriddle_hash(input, output, input_len);
...
void init(Handle<Object> exports) {
    ...
    exports->Set(String::NewSymbol("lyra2z16m330"), FunctionTemplate::New(lyra2z16m330)->GetFunction());
}
